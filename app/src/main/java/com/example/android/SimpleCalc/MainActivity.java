...
public class MainActivity extends Activity {
    ...
    private void compute(Calculator.Operator operator) {
        ...
        double operandTwo;
        try {
            numOne = getOperandText(mOperandOneEditText);
            numTwo = getOperandText(mOperandTwoEditText);

            if (numOne.equals("")){
                operandOne = 0;
            }else {
                operandOne = Double.parseDouble(numOne);
            }
            if (numTwo.equals("")){
                    operandTwo = 0;
            }else {
                operandTwo = Double.parseDouble(numTwo);
            }
